...
declare module Phaser {
  ...
  class Button extends Phaser.Image {
    ...
    setStateFrame(state: string, frame: string | number, switchImmediately?: boolean): void;
    changeStateFrame(state: string): boolean;
  }
  ...
  class Cache {
    ...
    spine: {
      [key: string]: PhaserSpine.SpineCacheData;
    };
  }
  ...
  class Loader implements PhaserSpine.SpineLoader {
    ...
    baseURL: string;
    cache: Phaser.Cache | PhaserSpine.SpineCache;
